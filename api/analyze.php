...
$newCheckMap = [
    ...
    'testing_first_principles' => ['#81 Documentation README Completeness and Clarity', fn() => check_testing_plus($owner, $repo, $pat, $tree, $languages, $sourceFiles, 'testing_first_principles')],
    'testing_aaa_pattern' => ['#82 Documentation Installation and Usage Guide Quality', fn() => check_testing_plus($owner, $repo, $pat, $tree, $languages, $sourceFiles, 'testing_aaa_pattern')],
    'testing_test_data_management' => ['#83 Documentation API Reference and Endpoint Notes', fn() => check_testing_plus($owner, $repo, $pat, $tree, $languages, $sourceFiles, 'testing_test_data_management')],
    'testing_flaky_test_risk' => ['#84 Documentation Architecture and Design Decision Notes', fn() => check_testing_plus($owner, $repo, $pat, $tree, $languages, $sourceFiles, 'testing_flaky_test_risk')],
    'testing_boundary_case_coverage' => ['#85 Documentation Changelog and Release Notes Hygiene', fn() => check_testing_plus($owner, $repo, $pat, $tree, $languages, $sourceFiles, 'testing_boundary_case_coverage')],
    'testing_contract_validation' => ['#86 Documentation Configuration and Environment Guide', fn() => check_testing_plus($owner, $repo, $pat, $tree, $languages, $sourceFiles, 'testing_contract_validation')],
    'testing_security_paths' => ['#87 Documentation Security and Compliance Notes', fn() => check_testing_plus($owner, $repo, $pat, $tree, $languages, $sourceFiles, 'testing_security_paths')],
